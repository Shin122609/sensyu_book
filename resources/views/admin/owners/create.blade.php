            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="bg-white py-6 sm:py-8 lg:py-12">
                    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                        ...
                        <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-6">オーナー登録</h2>
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            ...
                            <div class="-m-2">
                                ...
                                <button type="submit" class=" text-white bg-blue-600 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">登録</button>
                                </div>
                            </div>
                            </form>
                        </div>
