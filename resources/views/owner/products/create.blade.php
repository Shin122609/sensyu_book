                        ...
                        @csrf 
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                ...
                                <div class="relative flex justify-around">
                                    ...
                                    <div><input type="radio" name="is_selling" value="0" class="mr-2" >販売停止中</div>
                                </div>
                                </div>
                                <div class="p-2 w-full flex justify-around mt-20">
                                    ...
                                    <button type="submit" class=" text-white bg-blue-600 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">登録する</button>
                                </div>
                            </div>
                    </form>
                </div>
